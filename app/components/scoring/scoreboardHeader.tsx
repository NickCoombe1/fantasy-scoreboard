...
export default function ScoreBoardHeader({
  ...
  return (
    <div className="self-stretch justify-start items-center gap-2 md:gap-6 flex flex-col ">
      <div
        className={`self-stretch justify-start items-center gap-4 md:gap-6 flex ${alignPoints === "left" ? "flex-col" : "flex-col-reverse md:flex-row md:inline-flex"} `}
      >
        {alignPoints === "left" && (
          <div className="w-[3.375rem] h-[3.375rem] md:h-[4.4rem] px-6 md:px-10 py-6  bg-light-default dark:bg-white  rounded-2xl border border-white/50 justify-center items-center flex self-start">
        ...
        {alignPoints === "right" && (
          <div className="w-[3.375rem] h-[3.375rem] md:h-[4.4rem] px-6 md:px-10 py-6  bg-light-default dark:bg-white  rounded-2xl border border-white/50 justify-center items-center flex self-end">
            <div className="text-center text-[#eae8f0] dark:text-light-90 text-base md:text-[1.625rem] font-semibold font-roobert leading-[.25rem] md:leading-normal">
              {" "}
              {totalPoints}
            </div>
