  ...
  return (
    <div className={"min-h-[80vh] flex flex-col items-center"}>
      <TabGroup className={"w-full"}>
        <div className="w-full md:px-1 pt-8 md:pb-1 bg-black/5 dark:bg-black/20 rounded-lg shadow backdrop-blur-2xl flex-col justify-start items-center gap-8 inline-flex">
